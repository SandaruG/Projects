    ...
    <nav id="nav" x-data="{ open: false }" role="navigation" class="w-full">
      <div class="container mx-auto flex flex-wrap items-center md:flex-no-wrap">
        <div class="mr-4 md:mr-8">
          <a href="../index.html" class="text-2xl font-signika font-bold">Malcolm Lismore</a>
        </div>
        ...
        <div id="menu"
          ...
          <ul id="ulMenu"
            ...
            <li class="group transition duration-300">
              <a href="services.html" class="font-signika text-2xl">SERVICES
  ...
  <footer>
    <div class="max-w-screen-xl py-16 mx-auto">
      <div class="grid grid-cols-1 gap-8 text-center mx-auto">
        <div>
          <p class="font-signika"><b>Malcolm Lismore</b></p>
        </div>
        <div class="font-signika">
          <ul class="flex justify-center space-x-5">
            <li>
              <a href="https://www.facebook.com/profile.php?id=100091949740023" class="hover:underline">Facebook</a>
            </li>
            <li>
              <a href="https://www.instagram.com/malcolmlismore" class="hover:underline">Instagram</a>
            </li>
            <li>
              <a href="https://www.linkedin.com/in/malcolmlismore" class="hover:underline">LinkedIn</a>
            </li>
          </ul>
        </div>
        <div class="font-signika">
          <a href="contact.html" class="hover:underline">info@example.com</a>
        </div>
        <div class="font-signika">
